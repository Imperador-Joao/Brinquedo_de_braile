...
servoPos servoPos8;
*/
String listaDeServoPos[8];
Servo listaDeServos[] = {servo1,servo2,servo3,servo4,servo5,servo6,servo7,servo8};
...
{
  int valor = 0;
  Serial.println(listaDeServoPos[indiceServo]);
  valor = binToDec(listaDeServoPos[indiceServo]);  // binario de 3 digitos -> valor de 0 a 7
  ...
  listaDeServos[indiceServo].write(posicaoGraus);
